...
const savedColors = ['E9AFFC', 'AFF2FC', getRandomHexColor(), getRandomHexColor(), getRandomHexColor(), getRandomHexColor(), getRandomHexColor(), getRandomHexColor(), getRandomHexColor(), getRandomHexColor()];
const presets = {
  1: {
  ...
  5: {
    ...
    7: {
    colors: ["B9FBFF", "FFB8F4"],
  },
      8: {
    colors: ["EB1616", "EBCA16"],
  },
      9: {
    colors: ["fb00ff", "00B4FF", "000000", "00FF2A"],
  },
      10: {
    colors: ["00FFF0", "ffec00", "3af800"],
  }
}
const formats = {
  0: {
...
function updateOutputText(event) {
  ...
  if (format.outputPrefix) {
    ...
    if (nickName.value) {
      ...
      if (!nickName.value.match(letters)) nickName.value = 'Type something!';
    }
  }
